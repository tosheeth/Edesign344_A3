...
def apply_ltspice_filter1(simname,sig_in_x,sig_in_y,**kwargs):
  ...
  IR1 = ltr.get_trace("V(vtempoutadc)")
...
def apply_ltspice_filter2(simname,sig_in_x,sig_in_y,**kwargs):
  ...
  IR1 = ltr.get_trace("V(vheartpulsesout)")
  x = ltr.get_trace("time") 
